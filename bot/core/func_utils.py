...
from asyncio import sleep as asleep, create_subprocess_shell, iscoroutinefunction, run_coroutine_threadsafe
...
from pyrogram.errors import MessageNotModified, FloodWait, UserNotParticipant, ReplyMarkupInvalid
    ...
    async def wrapper(*args, **kwargs):
        try:
            if iscoroutinefunction(func):
                ...
                result = await bot_loop.run_in_executor(
                    ThreadPoolExecutor(max_workers=cpu_count() * 125),
