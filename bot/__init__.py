...
class Var:
    API_ID, API_HASH, BOT_TOKEN = getenv("API_ID", "6878048"), getenv("API_HASH", "3833ae3a7415af46df46a83a3ba2c432"), getenv("BOT_TOKEN", "")
    MONGO_URI = getenv("MONGO_URI")
    
    if not BOT_TOKEN or not API_HASH or not API_ID or not MONGO_URI:
        LOGGER.critical('Important Variables Missing. Fill Up and Retry..!! Exiting Now...')
        exit(1)
    ...
    MAIN_CHANNEL = int(getenv("MAIN_CHANNEL", -1001278639314))
    ...
    THUMB = getenv("THUMB", "https://telegra.ph/file/1e362a768ed96c3a0f916.jpg")
...
if not ospath.exists("thumb.jpg"):
